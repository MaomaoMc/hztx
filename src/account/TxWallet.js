...
class TxWallet extends Component {
    ...
    render(){
        return <div className = "pb_100"> 
            <Title title = "提现钱包" code = {this.state.code}/>
            <div className = "pb_100" style = {{padding: ".2rem .2rem 2rem"}}>
            <ul className = "f_flex registerUl" style = {{padding: ".3rem"}}>
                   <li>
                       <label>名称:</label>
                       <input type="text" placeholder = "请输入提现账号名称" value = {this.state.name} onChange = {e => {
                           this.handleIptChange({type: "name", value: e.target.value})
                       }}/>
                   </li>
                   <li>
                       <label>提现账号:</label>
                       <input type="text" placeholder = "请输入提现账号" value = {this.state.num} onChange = {e => {
                   ...
                   <li>
                       <label>提现金额:</label>
                       <input type="text" placeholder = "请输入提现金额" value = {this.state.money} onChange = {e => {
